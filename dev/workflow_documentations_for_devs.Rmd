...
YOUR_DATA_PATH <- paste0(ROOT, "data/data103/data_go/BcellGSE71176_p53.csv")
YOUR_EXPERIMENT_PATH <- paste0(ROOT, "data/data103/data_go/BcellGSE71176_p53_sampleInfo.csv")
...
idep_data$species_choice[grep("Human", names(idep_data$species_choice))]

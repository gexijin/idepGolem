...
get_genome_plot <- function(genome_plot_data,
...
#' PREDA PACKAGE ERROR ###########################
get_genome_plot_data <- function(genome_plot_data_pre,
                                 all_gene_info,
                                 select_contrast,
                                 limma,
                                 regions_p_val_cutoff,
  ...
  get_chr_number <- function(chr_name,
                             chromosomes_numbers,
                             chromosomes) {
    return(
...
#' PREDA PACKAGE ERROR ########################
get_genome_plot_data_pre <- function(select_contrast,
                                     limma,
                                     all_gene_info) {
  if (length(limma$comparisons) == 1) {
    top_1 <- limma$top_genes[[1]]

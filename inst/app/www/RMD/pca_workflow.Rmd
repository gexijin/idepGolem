...
Principal component analysis was performed using iDEP v`r packageVersion("idepGolem")`. The 2D PCA plot displays PC`r params$pc_x` on the x-axis and PC`r params$pc_y` on the y-axis`r if (!is.null(params$color) && params$color != "Names") paste0(", colored by ", params$color) else ""`

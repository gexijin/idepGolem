...
```{r gene_plot, fig.height=5.5, fig.width=7.5}
if (!is.null(params$selected_gene) && length(params$selected_gene) > 0) {
  ...
  cat("No genes selected for gene plot.\n")
}
```

Generated using iDEP v2.21 (https://bioinformatics.sdstate.edu/idep). `r format(Sys.time(), "%Y-%m-%d %H:%M:%S %Z")`. Accuracy not guaranteed.

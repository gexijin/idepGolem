...
cat(paste0("File format: ",params$data_file_format))
cat(paste0("Data: ",params$YOUR_DATA_PATH))
cat(paste0("Design File: ",params$YOUR_EXPERIMENT_PATH))
cat(paste0("Do not convert to Ensemble: ", params$no_id_conversion))
#BcellGSE71176_p53.csv
#GSE37704_sailfish_genecounts
#YOUR_DATA_PATH <- "F:/data104b_final/data_go/GSE37704_sailfish_genecounts.csv"

...
YOUR_EXPERIMENT_PATH <- "F:/data104b_final/data_go/GSE37704_sailfish_design.csv"
...
load_data <- input_data(
  ...
  experiment_file = NULL,#experiment_file,
  go_button = FALSE,
...
## PCA plots
```{r}
detect_groups(colnames(processed_data$data), NULL)
PCA_plot(
  data = processed_data$data,
  sample_info = load_data$sample_info,
